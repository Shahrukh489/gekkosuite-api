...
VALUES
    ('11111111-1111-1111-1111-111111111111', 'Dev Org', 'Seeded for local testing', 'ACTIVE', '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z', FALSE, NULL);
...
VALUES
    ('22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'admin@gekkosuite.com', 'fzR6hQsI5Vr6eeTO8qCZLw==:duYlawAZ54cuHXLRDMu4vAUlMu0WDO/+UfC7LobIwK0=', 'Dev',    'User',    NULL,          TRUE, TRUE,  NULL,                                     '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z', FALSE, NULL),
    ('10000000-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111', 'marcus@gekkosuite.com',      'bmQ2G6/ojp92m1cBFOEkcw==:MzCFYs9YtTb+iv4YoAR1uuaW17EXRrBPAHWC9gVTg3Y=', 'Marcus', 'Manager', '+1 555 0102', TRUE, FALSE, '22222222-2222-2222-2222-222222222222', '2026-01-06T09:05:00Z', '2026-01-06T09:05:00Z', FALSE, NULL);
...
VALUES
    ('20000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'Downtown', 'PHYSICAL', 'Flagship',       '1 Main St', 'Austin', 'TX', '78701', 'US', 'USD', '+1 555 0200', 'downtown@gekkosuite.com', TRUE,  '2026-01-05T12:00:00Z', '2026-01-05T12:00:00Z', FALSE, NULL),
    ('20000000-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'Online',   'ONLINE',   'Web storefront', NULL,        NULL,     NULL, NULL,    'US', 'USD', NULL,          'shop@gekkosuite.com',     FALSE, '2026-01-07T10:00:00Z', '2026-01-07T10:00:00Z', FALSE, NULL);
...
VALUES
    ...
    ('30000000-0000-0000-0000-000000000003', 'sale',         'create', 'Ring up a sale',                                  FALSE),
    ('30000000-0000-0000-0000-000000000004', 'product',      'read',   'View products',                                   FALSE),
    ('30000000-0000-0000-0000-000000000005', 'product',      'edit',   'Edit products and stock',                         FALSE),
    ('30000000-0000-0000-0000-000000000006', 'order',        'refund', 'Refund an order',                                 FALSE);
...
VALUES
    ...
    ('40000000-0000-0000-0000-000000000004', 'Cashier',   'Ring up sales',              TRUE, NULL, 'STORE',        '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
    ('40000000-0000-0000-0000-000000000005', 'Manager',   'Run a store',                TRUE, NULL, 'STORE',        '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z');
...
VALUES
    ...
    ('50000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000003', 'STORE',        '11111111-1111-1111-1111-111111111111', '20000000-0000-0000-0000-000000000001', TRUE, '2026-01-06T09:05:00Z', '2026-01-06T09:05:00Z', FALSE, NULL),
    ('50000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000003', 'STORE',        '11111111-1111-1111-1111-111111111111', '20000000-0000-0000-0000-000000000002', TRUE, '2026-01-08T09:05:00Z', '2026-01-08T09:05:00Z', FALSE, NULL);
