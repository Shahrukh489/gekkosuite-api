...
/// <summary>
/// Dapper type handler that maps a Postgres json/jsonb column to T by (de)serializing JSON.
/// </summary>
public class JsonTypeHandler<T> : SqlMapper.TypeHandler<T>
{
    ...
    /// <summary>
    /// Deserializes the JSON text from the DB column into T.
    /// </summary>
    ...
    /// <summary>
    /// Serializes T back to JSON text for a write parameter.
    /// </summary>
